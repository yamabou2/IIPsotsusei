...
<link rel="stylesheet" type="text/css" href="story7.css">
<style>
 /* 波紋の基本スタイル */
    .ripple {
        position: absolute;
...
<body id="story7Body" class="bg-grass">

    <!-- 勇者 -->
    <img src="images/透過装備全有.png" class="hero-image" id="hero">

    <!-- 敵（暗くした状態） -->
    <img src="images/toukapokerboss.png" class="enemy-image dark" id="enemy">
    ...
    <form id="storyForm" action="StoryServlet" method="post" style="display:none;">
        <input type="hidden" name="current" value="story7">
    </form>
    <!-- ▲▲ ここまで ▲▲ -->

<script>
const firstLine = "カードが風に散り、女は崩れ落ちる。";
