...
<link rel="stylesheet" type="text/css" href="story5.css">
<style>
 /* 波紋の基本スタイル */
    .ripple {
        position: absolute;
...
<body id="story5Body" class="bg-grass">
    ...
    <form id="storyForm" action="StoryServlet" method="post" style="display:none;">
        <input type="hidden" name="current" value="story5">
    </form>
    <!-- ▲▲ ここまで ▲▲ -->

<script>
const firstLine = "勇者は剣を下ろす。村は、やはり静かなままだ。";

const nextLines = [
    "人が消えた理由の一端だけが、そこに残っていた。",
    "勇者は村を後にする。\n先へ進むために。"
];
